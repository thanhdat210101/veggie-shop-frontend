...
export class AllProductComponent implements OnInit {
  ...
  getProducts() {
    this.productService.getAll().subscribe(data => {
      ...
      this.toastr.error('Lỗi server! all product 1', 'Hệ thống');
    })
  }
      ...
      if (data == null) {
        this.customerService.getByEmail(email).subscribe(data => {
          ...
          this.favoriteService.post(new Favorites(0, new Customer(this.customer.userId), new Product(id))).subscribe(data => {
            ...
            this.favoriteService.getByEmail(email).subscribe(data => {
              ...
              this.toastr.error('Lỗi truy xuất dữ liệu! all product 2 ', 'Hệ thống');
            })
          }, error => {
        ...
        this.favoriteService.delete(this.favorite.favoriteId).subscribe(data => {
          ...
          this.favoriteService.getByEmail(email).subscribe(data => {
            ...
            this.toastr.error('Lỗi truy xuất dữ liệu! all product 3', 'Hệ thống');
          })
        }, error => {
