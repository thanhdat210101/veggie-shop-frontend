...
export class HomepageComponent implements OnInit {
  ...
  getAllProductBestSeller() {
    this.productService.getBestSeller().subscribe(data=>{
      ...
      this.toastr.error('Lỗi server! home page 1', 'Hệ thống')
      console.log(error);
    })
  }
  ...
  getAllProductLatest() {
    this.productService.getLasted().subscribe(data=>{
      ...
      this.toastr.error('Lỗi server! home page 2', 'Hệ thống')
      console.log(error);
    })
  }
  ...
  getAllProductRated() {
    this.productService.getRated().subscribe(data=>{
      ...
      this.toastr.error('Lỗi server! home page 3', 'Hệ thống')
      console.log(error);
      ...
      if (data == null) {
        this.customerService.getByEmail(email).subscribe(data => {
          ...
          this.favoriteService.post(new Favorites(0, new Customer(this.customer.userId), new Product(id))).subscribe(data => {
            ...
            this.favoriteService.getByEmail(email).subscribe(data=>{
              ...
              this.toastr.error('Lỗi truy xuất dữ liệu! home page 4', 'Hệ thống');
            })
          }, error => {
        ...
        this.favoriteService.delete(this.favorite.favoriteId).subscribe(data => {
          ...
          this.favoriteService.getByEmail(email).subscribe(data=>{
            ...
            this.toastr.error('Lỗi truy xuất dữ liệu! home page 5', 'Hệ thống');
          })
        }, error => {
